...
public:		// ======================================
	...
	inline	static	bool	GetSearchSubDirState(void) {return(GetEnableSubDirButton() ? m_bSearchSubDirState : false);}
			bool		Exec(wchar_t *);
	inline	static	void	SetCheckBoxTitle(const wchar_t* title) {pCheckBoxTitle = title;}
	inline	static	const wchar_t* GetCheckBoxTitle(void) {return (pCheckBoxTitle);}
...
private:	// ======================================
	...
	static	const wchar_t* pCheckBoxTitle;
